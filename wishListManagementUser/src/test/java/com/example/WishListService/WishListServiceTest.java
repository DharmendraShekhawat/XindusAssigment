...
class WishListServiceTest {
    ...
    void addWishListItem() {
        MyUser myUser = myUserRepository.findById(1).orElse(null);
        WishListItem wishListItem = wishListService.addWishListItem(new WishListItem(11 , "SmartPhone" , "An one plus smart phone with great camera quality" , myUser, LocalDateTime.now()));
